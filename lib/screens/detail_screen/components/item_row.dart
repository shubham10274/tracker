...
import 'package:weight_track/models/weights_model.dart';
...
class ItemRow extends StatelessWidget {
  ...
  const ItemRow({Key? key, required this.weights, required this.id})
      : super(key: key);
            ...
            children: [
              ...
              Row(
                children: [
                  ElevatedButton(
                    onPressed: () {
                      WeightOperations.editWeight(context, id);
                    },
                    child: Icon(
                      Icons.edit,
                      size: 20,
                  ...
                  OutlinedButton(
                    onPressed: () {
                      WeightOperations.deleteWeight(context, id);
                    },
                    child: Icon(
